    ...
    <div class="settings card">
      ...
      <div class="input-group">
        <div class="input-wrapper">
          ...
          />
          <button v-if="newGroupName" class="clear-text-btn" @click="newGroupName = ''" title="清除文字">✖</button>
        </div>
...
.input-wrapper input {
  width: 100%; padding: 12px; padding-right: 35px; border: 2px solid #e0e0e0;
  border-radius: 8px; font-size: 16px; transition: border-color 0.3s; box-sizing: border-box;
}
.input-wrapper input:focus { outline: none; border-color: #42b983; }
